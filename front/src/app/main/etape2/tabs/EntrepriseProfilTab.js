...
function EntrepriseProfilTab(props)
{
    ...
    {
        dispatch(authActions.submitRegisterEntreprise(model));
    }
        ...
        <div className="w-full">
            ...
            >
                <TextFieldFormsy
                    ...
                    type="text"
                    name="ice"
                    label="Identifiant Commun d'Entreprise"
                    variant="outlined"
                    required
                />
...
export default EntrepriseProfilTab;
